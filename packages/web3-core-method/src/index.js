...
Method.prototype.buildCall = function() {
    var method = this,
        isSendTx = (method.call === 'owt_sendTransaction' || method.call === 'owt_sendRawTransaction'); // || method.call === 'personal_sendTransaction'
    ...
    var send = function () {
        ...
        var sendRequest = function(payload, method) {
            ...
            if (method && method.accounts && method.accounts.wallet && method.accounts.wallet.length) {
                ...
                // owt_SENDTRANSACTION
                if (payload.method === 'owt_sendTransaction') {
                ...
                // owt_SIGN
                } else if (payload.method === 'owt_sign') {
